...
### إعادة خياطة الصورة كحكاية إنسانية دافئة من الرقع
...
> قماش من المصدر · حافة مهدّبة · خياطة يدوية · فراغ فعّال · شعور خفي

تُعاد صياغة العلاقة غير المنطوقة في الصورة كرقع معاصرة من قطن مربّع وكتان وخيش مغسول وحواف مهدّبة ورقع وخياطة يدوية ظاهرة. ويحمل الفراغ الصحبة والمسافة والنمو والتوقف والانتماء واللقاء والزمن.
...
- **الارتباط بالمصدر:** إعادة خياطة الصورة كحكاية إنسانية دافئة من الرقع
- **بصمة الأسلوب:** قماش من المصدر · حافة مهدّبة · خياطة يدوية · فراغ فعّال · شعور خفي
...
توجد القيود الجمالية وقواعد الرفض الكاملة في المهارة وتوجيهات الإنتاج. وهي تحفظ دافع النص الأصلي من دون تحويل لوحة 3:4 التاريخية إلى قيمة افتراضية خفية. [SKILL.md](SKILL.md) · [production prompt](references/xxd-panel-038-prompt.en.md)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 038 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 038 نموذج 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 038 نموذج 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 038 نموذج 4"></a></td>
  </tr>
</table>

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج الدافع الجمالي للإصدار 038 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع للتوليد أو إعدادات افتراضية حالية.
...
| --- | --- | --- |
| `top-bottom` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء في الأعلى وتصميم 038 في الأسفل، نحو 50/50 |
| `left-right` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء يساراً وتصميم 038 يميناً، نحو 50/50 |
| `design-only` | لوحة نهائية أكدها المستخدم | يملأ تصميم 038 اللوحة ولا تظهر صورة المصدر |
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-038`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/038-source.md) · [توجيه الإنتاج الإنجليزي](references/xxd-panel-038-prompt.en.md) · [توجيه الإنتاج الصيني](references/xxd-panel-038-prompt.zh-CN.md)
...
<div align="center" dir="rtl"><strong>يحفظ القماش الشكل، ويحفظ الفراغ المسافة بيننا.</strong></div>
