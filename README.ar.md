...
لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/038-source.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-038-prompt.en.md)

## الموجّه الأصلي هو المرجع الجمالي الوحيد

الملف `references/038-source.md` هو المرجع الإبداعي والجمالي الوحيد للمشروع. لا تلخّص المهارة نصّه ولا توسعه، ولا تفرض لوحة ألوان مشتركة أو «دافعاً جمالياً» أو عنواناً أو حزمة نصوص قصيرة. يتبع GPT Image 2 قواعد الموجّه الأصلي نفسه في اللون والخامة والتكوين والفراغ والنص والطباعة.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/038-source.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-038-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-038-prompt.zh-CN.md)
