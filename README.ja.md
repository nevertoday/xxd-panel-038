...
`references/038-source.md` が、このプロジェクト唯一の創作・美的基準です。Skill は原文を要約・拡張せず、共通の配色計画、美的動機、タイトル、マイクロコピーを追加しません。色、素材、構図、余白、言葉、タイポグラフィは、GPT Image 2 が原文プロンプトの規則どおりに実行します。
...
完全仕様: [Skill ワークフロー](SKILL.md) · [原始スタイル資料](references/038-source.md) · [英語ランタイムアダプター](references/xxd-panel-038-prompt.en.md) · [中国語ランタイムアダプター](references/xxd-panel-038-prompt.zh-CN.md)
