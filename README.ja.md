...
完全な美的制約と拒否項目は Skill と生成プロンプトにあります。原文の美的動機を守りつつ、歴史的な3:4画布を隠れた既定値にはしません。 [SKILL.md](SKILL.md) · [production prompt](references/xxd-panel-038-prompt.en.md)
...
| モード | 画角ルール | 成果物 |
| --- | --- | --- |
| `top-bottom` | ユーザー確認済みの完成画角 | 完成キャンバスを一度に生成：上に高忠実度の元画像、下に 038 デザイン、約50/50 |
| `left-right` | ユーザー確認済みの完成画角 | 完成キャンバスを一度に生成：左に高忠実度の元画像、右に 038 デザイン、約50/50 |
| `design-only` | ユーザー確認済みの完成画角 | 038 デザインが全画面を満たし、元画像は表示しない |
...
完全仕様: [Skill ワークフロー](SKILL.md) · [原始スタイル資料](references/038-source.md) · [英語生成プロンプト](references/xxd-panel-038-prompt.en.md) · [中国語生成プロンプト](references/xxd-panel-038-prompt.zh-CN.md)
