...
**Panel 038**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진을 따뜻한 휴머니스트 패치워크 이야기로 다시 꿰매기**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
```text
$xxd-panel-038
이 사진을 사용하고, 먼저 구성 모드와 문구 설정을 물어본 다음 새로운 비트맵 결과물을 생성해 주세요.
```
