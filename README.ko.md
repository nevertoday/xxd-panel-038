...
`references/038-source.md`는 이 프로젝트의 유일한 창작·미적 기준입니다. Skill은 원문을 요약하거나 확장하지 않으며 공통 색상 계획, 미적 동기, 제목, 마이크로카피를 추가하지 않습니다. 색, 재료, 구성, 여백, 문구, 타이포그래피는 GPT Image 2가 원본 프롬프트의 규칙대로 수행합니다.
...
전체 사양: [Skill 워크플로](SKILL.md) · [원본 스타일 자료](references/038-source.md) · [영문 런타임 어댑터](references/xxd-panel-038-prompt.en.md) · [중문 런타임 어댑터](references/xxd-panel-038-prompt.zh-CN.md)
