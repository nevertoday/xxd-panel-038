...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 038 sample 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 038 sample 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 038 sample 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090807474467291568"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 038 sample 4"></a></td>
  </tr>
</table>
...
These four works reuse the same four independent sources as the 16:9 set above, now regenerated as complete 3:4 top–bottom canvases. The original photograph remains above; the lower design follows Panel 038's original brief. English copy is generated only from each photograph's content, mood, or implication, and every result was individually reviewed.
...
**Panel 038** is suited to work that must retain the source's essential content while pursuing this visual direction: **Re-sew the photograph as a warm humanist patchwork story**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 038 on this image and recommend the best layout and size first.
...
|---|---|
| **What you will get** | Re-sew the photograph as a warm humanist patchwork story |
| **Recognizable signature** | SOURCE FABRIC · FRAYED EDGE · HAND STITCH · ACTIVE WHITESPACE · HIDDEN FEELING |
...
/xxd-panel-038 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-038 photo.jpg --mode design-only --size 3:4 --text prompt --locale en-GB

# Use exact copy without rewriting, translating, or adding a title
/xxd-panel-038 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-038 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 038 to a whole directory; shared settings resolve once
/xxd-panel-038 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
...
Claude Code users may link the same folder under `~/.claude/skills/xxd-panel-038`. Restart the agent session after installation.
...
<div align="center"><strong>The cloth keeps the form; the empty space keeps the distance between us.</strong></div>
