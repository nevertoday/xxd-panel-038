...
This is not a second aesthetic prompt. Read and use `references/038-source.md` in full and verbatim before generation; it is the sole creative and aesthetic authority for Panel 038. This file only appends the current user's runtime variables.
...
```text
complete verbatim 038-source.md
